 ...
 * * Условия: если этажей 1-4 - “Малоэтажный дом”, 5-8 - “Среднеэтажный дом”, 9 и
 * более - “Многоэтажный дом”. Также, необходимо учесть что может быть введено отрицательное значение,
...
public class Task1 {
    public static void main(String[] args) {
        ...
        int etag = scanner.nextInt();
        if (etag > 0 && etag < 5) {
            System.out.println("Малоэтажный дом");
        } else if (etag > 4 && etag < 9) {
